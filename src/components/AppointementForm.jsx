        ...
        <FormProvider {...methods}>
          <form className="w-full lg:w-4/5 mx-auto flex flex-col gap-y-6 px-6 py-10 border border-steel-blue rounded-lg shadow-2xl">
            ...
            <div>
              ...
              />
              <FormDescription>
                How many windows would like us to clean ?
              </FormDescription>
            </div>
            <div>
              <MyInput
                label="Dust / Wipe-Down blinds"
                placeholder="Dust / Wipe-Down blinds"
                type="text"
                id="blinds"
              />
              <FormDescription>
                How many blinds do you need us to dust / wipe-down ?
              </FormDescription>
            </div>
            <div>
              <MyInput
                label="Conditions"
                placeholder="(1-tidy, 10-needs a lot of work)"
                type="text"
                id="Conditions"
              />
              <FormDescription>Rate your place.</FormDescription>
            </div>
            <div>
              <MySelect
